...
imdi_environment.imdi_generator = function(){
	...
	var get_metadata_language = function(){
		...
		var return_string = APP_CONF.LanguageCodePrefix;	
	...
	var create_imdi_corpus = function () {
		...
		return_string += create_imdi_header("CORPUS",APP_CONF.originator,"1.0",today());
        ...
        for (var i=0; i<session.sessions.length; i++){
			return_string += xml.element("CorpusLink",get(APP_CONF.session_dom_element_prefix+session.sessions[i].id+"_session_name")+".imdi",
			[["Name",get(APP_CONF.session_dom_element_prefix+session.sessions[i].id+"_session_name")]]);
		}
	...
	var create_imdi_session = function (session_id) {
		...
		return_string+=xml.header;
		return_string+=create_imdi_header("SESSION",APP_CONF.originator,"1.0",today());
		...
		if ((get(APP_CONF.session_dom_element_prefix+session_id+"_session_date_year") != "") && (get(APP_CONF.session_dom_element_prefix+session_id+"_session_date_year") != "YYYY")){
			...
			return_string += get(APP_CONF.session_dom_element_prefix+session_id+"_session_date_year") + "-" + get(APP_CONF.session_dom_element_prefix+session_id+"_session_date_month") + "-" + get(APP_CONF.session_dom_element_prefix+session_id+"_session_date_day");
		...
		return_string+=xml.element("Description",get(APP_CONF.session_dom_element_prefix+session_id+"_session_description"),[["LanguageId",get_metadata_language()],["Link",""]]);
   
		return_string+=xml.tag("MDGroup",0);
		return_string+=xml.tag("Location",0);
		return_string+=xml.element("Continent",get(APP_CONF.session_dom_element_prefix+session_id+"_session_location_continent"),[["Link","http://www.mpi.nl/IMDI/Schema/Continents.xml"],["Type","ClosedVocabulary"]]);
		return_string+=xml.element("Country",get(APP_CONF.session_dom_element_prefix+session_id+"_session_location_country"),[["Link","http://www.mpi.nl/IMDI/Schema/Countries.xml"],["Type","OpenVocabulary"]]);
		...
		return_string+=xml.element("Description",get(APP_CONF.session_dom_element_prefix+session_id+"_project_description"),[["LanguageId",get_metadata_language()],["Link",""]]);
		...
		for (var r=0; r<session.sessions[session.getSessionIndexFromID(session_id)].resources.mediaFiles.length; r++){  
			...
			return_string += insert_mediafile(get(APP_CONF.session_dom_element_prefix+session_id+'_mediafile_'+id+"_name"),get(APP_CONF.session_dom_element_prefix+session_id+'_mediafile_'+id+"_size"));
		...
		for (var r=0; r<session.sessions[session.getSessionIndexFromID(session_id)].resources.writtenResources.length; r++){  
			...
			return_string += insert_written_resource(get(APP_CONF.session_dom_element_prefix+session_id+'_mediafile_'+id+"_name"),get(APP_CONF.session_dom_element_prefix+session_id+'_mediafile_'+id+"_size"));
	...
	var insert_session_content = function (session_id) {
		...
		return_string += xml.element("Genre",get(APP_CONF.session_dom_element_prefix+session_id+"_content_genre"),[["Link","http://www.mpi.nl/IMDI/Schema/Content-Genre.xml"],["Type","OpenVocabulary"]]);
		return_string += xml.element("SubGenre",get(APP_CONF.session_dom_element_prefix+session_id+"_content_subgenre"),[["Link","http://www.mpi.nl/IMDI/Schema/Content-SubGenre.xml"],["Type","OpenVocabularyList"]]);
		return_string += xml.element("Task",get(APP_CONF.session_dom_element_prefix+session_id+"_content_task"),[["Link","http://www.mpi.nl/IMDI/Schema/Content-Task.xml"],["Type","OpenVocabulary"]]);
		...
		return_string += xml.element("Interactivity",get(APP_CONF.session_dom_element_prefix+session_id+"_content_communication_context_interactivity"),[["Link","http://www.mpi.nl/IMDI/Schema/Content-Interactivity.xml"],["Type","ClosedVocabulary"]]);
		return_string += xml.element("PlanningType",get(APP_CONF.session_dom_element_prefix+session_id+"_content_communication_context_planningtype"),[["Link","http://www.mpi.nl/IMDI/Schema/Content-PlanningType.xml"],["Type","ClosedVocabulary"]]);
		return_string += xml.element("Involvement",get(APP_CONF.session_dom_element_prefix+session_id+"_content_communication_context_involvement"),[["Link","http://www.mpi.nl/IMDI/Schema/Content-Involvement.xml"],["Type","ClosedVocabulary"]]);	
		return_string += xml.element("SocialContext",get(APP_CONF.session_dom_element_prefix+session_id+"_content_communication_context_socialcontext"),[["Link","http://www.mpi.nl/IMDI/Schema/Content-SocialContext.xml"],["Type","ClosedVocabulary"]]);
		return_string += xml.element("EventStructure",get(APP_CONF.session_dom_element_prefix+session_id+"_content_communication_context_eventstructure"),[["Link","http://www.mpi.nl/IMDI/Schema/Content-EventStructure.xml"],["Type","ClosedVocabulary"]]);
		...
		return_string += xml.element("Description",get(APP_CONF.session_dom_element_prefix+session_id+"_content_description"),[["LanguageId",get_metadata_language()],["Link",""]]);
	...
	var insert_actor = function (session_id, actor_id) {
		...
		for (var l=0; l<actor.actors[i].languages.length; l++){
			...
			return_string += xml.tag("Language",0);
			return_string += xml.element("Id",APP_CONF.LanguageCodePrefix+actor.actors[i].languages[l].LanguageObject[0]);
